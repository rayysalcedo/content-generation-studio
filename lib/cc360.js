...
// Captured the working request from CC360's Network tab → Request Headers.
// Plain cross-origin: app.coursecreator360.com → backend.leadconnectorhq.com.
...
function backendHeaders(token, locationId, tokenId) {
  ...
  // CC360 UI call (Network tab → Headers → Request Headers section). The page is at
  // app.coursecreator360.com and makes plain cross-origin calls to backend.leadconnectorhq.com.
