...
// Gemini aspect ratios — match the actual template
const SIZE_PORTRAIT = '2:3';         // module cards are tall in the template
const SIZE_LANDSCAPE = '3:2';        // laptop mockup
const SIZE_SQUARE = '1:1';           // inside-card icons (template displays at 50x50)
