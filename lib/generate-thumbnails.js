...
// Pacing — OpenAI image rate limits are tier-based; this is conservative
const BATCH_SIZE = 1;          // serial — one image at a time
const BATCH_DELAY_MS = 3000;   // 3s between images
