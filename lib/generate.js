...
function buildPdfPrompt({ pdfText, courseTitle, targetAudience, instructions }) {
  ...
  return `You are converting an existing course document into structured lesson content for GoHighLevel.
...
function buildDescriptionPrompt({ description, courseTitle, targetAudience, instructions, moduleCount, lessonsPerModule }) {
  ...
  return `You are designing a brand-new course from a brief description for GoHighLevel. The user has given you a course concept — your job is to invent a logical, comprehensive curriculum that teaches that concept well.
